...
"""
code-snippet-xblock documentation build configuration file.
...
project = 'code-snippet-xblock'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'code-snippet-xblock'
...
#
# html_title = 'code-snippet-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Code Snippet XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'code_snippet'),
                os.path.join(root_path, 'code_snippet/migrations')])
